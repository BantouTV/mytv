...
(function() {
  ...
  */
  J = {
    ...
    * @type {Object}
    */
    adapterModules: {"samsungtv": ["app", "inputs/remote", "uielements/map", "uielements/video.mediaelement", "utils/navigationhelper"], "browser": ["app", "uielement", "inputs/http", "inputs/keyboard", "inputs/mouse", "uielements/list", "uielements/mediacontrols", "uielements/page", "uielements/panel.manager", "uielements/video.mediaelement", "uielements/video.popup", "uielements/video.youtube.swf", "utils/activitymonitor", "utils/datasource", "utils/navigation", "utils/stresstest"]},
...
Joshfire.definedModules['joshfire/adapters/samsungtv/inputs/remote'] = function() { return (
function(Input, Class) {
      return Class(Input, {
        setup: function(callbackOnReady) {
          var self = this;
...
)(Joshfire.loadModule('joshfire/input'),Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('joshfire/vendor/json2'));
 };

Joshfire.definedModules['joshfire/adapters/samsungtv/app'] = function() { return (
...
)(Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('joshfire/adapters/browser/app'),Joshfire.loadModule('joshfire/main'),Joshfire.loadModule('joshfire/vendor/underscore'),Joshfire.loadModule('joshfire/vendor/json2'),Joshfire.loadModule('joshfire/adapters/samsungtv/inputs/remote'));
 };
...
)(Joshfire.loadModule('joshfire/adapters/samsungtv/app'),Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('src/tree.data'),Joshfire.loadModule('src/tree.ui'),Joshfire.loadModule('joshfire/vendor/underscore'),Joshfire.loadModule('joshfire/utils/splashscreen'));
 };
...
Joshfire.definedModules['joshfire/adapters/samsungtv/uielements/video.mediaelement'] = function() { return (
...
)(Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('joshfire/adapters/browser/uielements/video.mediaelement'));
 };