...
(function() {
  ...
  */
  J = {
    ...
    * @type {Object}
    */
    adapterModules: {"android": ["app", "inputs/touch", "uielements/list", "uielements/video.mediaelement", "utils/datasource"], "browser": ["app", "uielement", "inputs/http", "inputs/keyboard", "inputs/mouse", "uielements/list", "uielements/mediacontrols", "uielements/page", "uielements/panel.manager", "uielements/video.mediaelement", "uielements/video.popup", "uielements/video.youtube.swf", "utils/activitymonitor", "utils/datasource", "utils/navigation", "utils/stresstest"]},
        ...
        setDataPath: function(dataPath) {
          ...
          if (self.dataPath != dataPath || this.options.forceDataPathRefresh) {
            ...
            self.app.data.fetch(dataPath, false, function(err, data) {
              ...
              //Semble faire doublon dans le cas getChildren(), set data déja déclenché
...
Joshfire.definedModules['joshfire/adapters/android/inputs/touch'] = function() { return (
function(Input, Class, $) {
      /**
...
Joshfire.definedModules['joshfire/adapters/android/app'] = function() { return (
...
)(Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('joshfire/adapters/browser/app'),Joshfire.loadModule('joshfire/main'),Joshfire.loadModule('joshfire/vendor/underscore'),Joshfire.loadModule('joshfire/adapters/android/inputs/touch'),Joshfire.loadModule('joshfire/adapters/browser/inputs/mouse'));
 };
...
)(Joshfire.loadModule('joshfire/adapters/android/app'),Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('src/tree.data'),Joshfire.loadModule('src/tree.ui'),Joshfire.loadModule('joshfire/vendor/underscore'),Joshfire.loadModule('joshfire/utils/splashscreen'));
 };
        ...
        */
        insert: function(parentElement, callback) {
          ...
          var handle_iScroller = function(ev, data) {
            console.warn('handle iScroller', self.htmlId, self.scrollOptions)
...
)(Joshfire.loadModule('joshfire/uielements/list'),Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('joshfire/utils/grid'),Joshfire.loadModule('joshfire/vendor/underscore'),Joshfire.loadModule('joshfire/vendor/iscroll'),Joshfire.loadModule('joshfire/vendor/jquery'));
 };
...
Joshfire.definedModules['joshfire/adapters/android/uielements/video.mediaelement'] = function() { return (
...
)(Joshfire.loadModule('joshfire/uielements/video'),Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('joshfire/vendor/underscore'),Joshfire.loadModule('joshfire/main'));
 };