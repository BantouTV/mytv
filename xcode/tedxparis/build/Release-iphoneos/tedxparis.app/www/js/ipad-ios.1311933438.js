  ...
  */
  return Class(Input, {
    ...
    setup: function(callback) {
      ...
      $(window).live(hasTouchEvent() ? 'touchstart click tap MozTouchDown' : 'mousedown', function(e) {
      //$(window).live(hasTouchEvent() ? 'touchstart click tap MozTouchDown' : 'mousedown click', function(e) {
        for (var target = this; target && target != document; target = target.parentNode) {
          if ($(target).attr('data-josh-ui-path')) {
            ...
            if ((e.type=="mousedown") || (!elt.hasScroller && e.type!="click") || (e.type=="click" && elt.hasScroller)) {
...
)(Joshfire.loadModule('joshfire/main'),Joshfire.loadModule('joshfire/class'),Joshfire.loadModule('joshfire/utils/pool'),Joshfire.loadModule('joshfire/vendor/underscore'));
 };
